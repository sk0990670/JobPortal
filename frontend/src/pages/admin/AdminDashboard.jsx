  ...
  return (
    <div className="animate-fade-in space-y-8 pb-12">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-5">
        ...
        {/* Global Date Filter */}
        <div className="flex items-center gap-4 bg-white border border-gray-200 px-4 py-2 rounded-xl shadow-sm hover:shadow-md hover:border-primary-300 transition-all">
          <Calendar size={20} className="text-primary-500" />
          <div className="flex items-center gap-3">
            <div className="flex flex-col">
              <span className="text-[10px] font-bold uppercase tracking-wider text-gray-400 mb-0.5">Start</span>
              <input 
                type="date" 
                value={startDate} 
                onChange={e => setStartDate(e.target.value)}
                className="bg-transparent border-none outline-none text-gray-800 text-[13px] font-bold cursor-pointer [&::-webkit-calendar-picker-indicator]:opacity-50 hover:[&::-webkit-calendar-picker-indicator]:opacity-100 p-0"
              />
            </div>
            <span className="text-gray-300 font-bold mt-3">-</span>
            <div className="flex flex-col">
              <span className="text-[10px] font-bold uppercase tracking-wider text-gray-400 mb-0.5">End</span>
              <input 
                type="date" 
                value={endDate} 
