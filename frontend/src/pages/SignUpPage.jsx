...
const TermsContent = () => (
  <>
    ...
    <section>
      ...
      <p>For any questions regarding these Terms, contact our <a href="mailto:sk0990670+legal@gmail.com" className="text-primary-600 hover:underline">Legal Mail</a>.</p>
    </section>
  </>
);
...
const PrivacyContent = () => (
  <>
    ...
    <section>
      ...
      <p>We retain your data for as long as your account is active. You may request deletion of your account and associated data at any time by contacting our <a href="mailto:sk0990670+privacy@gmail.com" className="text-primary-600 hover:underline">Privacy Mail</a>. Some data may be retained for legal compliance purposes.</p>
    </section>
    ...
    <section>
      <h3 className="font-semibold text-gray-900 mb-1">10. Contact Us</h3>
      <p>For privacy-related questions or requests, contact our <a href="mailto:sk0990670+privacy@gmail.com" className="text-primary-600 hover:underline">Privacy Mail</a>.</p>
    </section>
  </>
);
